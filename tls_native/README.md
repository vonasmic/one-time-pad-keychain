...
Python bridge and native TLS server/client tools for testing TLS communication between the
STM32U5 device (or `JAVA_TLS_TEST` nodes) and a peer over USB or TCP.
...
- [Local mTLS test (`tls_client` vs JAVA_TLS_TEST)](#local-mtls-test-tls_client-vs-java_tls_test)
