...
/* Software SHA/HMAC path only — no STM32 HASH peripheral offload in wolfSSL */
#define NO_STM32_HASH
/* Software seed path — no HAL_RNG usage inside wolfSSL wc_GenerateSeed */
#define NO_STM32_RNG
/* Do not define STM32_RNG here; it would pull HAL_RNG into random.c */
